...
INLINE tFrac32 MLIB_Convert_F32FLT(register tFloat fltIn1,register tFloat fltIn2)
{
  ...
  return((fltInScaled>=1.0f) ? (tFrac32)INT32_MAX : ((fltInScaled<-1.0f) ? (tFrac32)INT32_MIN : (tFrac32)MLIB_Mul_FLT(fltInScaled,((tFloat)INT32_MAX)+1.0f)));
}
...
INLINE tFrac16 MLIB_Convert_F16FLT(register tFloat fltIn1,register tFloat fltIn2)
{
  ...
  return((fltInScaled>=1.0f) ? (tFrac16)INT16_MAX : ((fltInScaled<-1.0f) ? (tFrac16)INT16_MIN : (tFrac16)MLIB_Mul_FLT(fltInScaled,((tFloat)INT16_MAX)+1.0f)));
}
...
INLINE tFloat MLIB_Convert_FLTF16(register tFrac16 f16In1,register tFrac16 f16In2)
{
  ...
  return((f16In2>=(tFrac16)0) ? MLIB_Div_FLT((tFloat)MLIB_Mul_F32F16F16(f16In1,f16In2),(((tFloat)(INT32_MAX))+1.0f))
