/**
 * GMCLIB_Clark6Ph_SF_FLT.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void GMCLIB_Clark6Ph_w_FLT(SWLIBS_2Syst_FLT y1[1], SWLIBS_6Syst_FLT u1[1], GMCLIB_CLARK_6PH_T_FLT work1[1])
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 12-Sep-2023 09:21:11
 *
 */
...
#define S_FUNCTION_NAME  GMCLIB_Clark6Ph_SF_FLT
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "GMCLIB_CLARK_6PH_T_FLT", &dataTypeIdReg);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GMCLIB_Clark6PhInit_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GMCLIB_Clark6Ph_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GMCLIB_Clark6PhInit_w_FLT_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GMCLIB_Clark6Ph_w_FLT_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "GMCLIB_Clark6Ph_SF_FLT_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "GMCLIB_Clark6Ph_SF_FLT_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        DTypeId __GMCLIB_CLARK_6PH_T_FLTId = ssGetDataTypeId(S, "GMCLIB_CLARK_6PH_T_FLT");
        ...
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __SWLIBS_6Syst_FLTId);
        __dtSizeInfo[3] = ssGetDataTypeSize(S, __GMCLIB_CLARK_6PH_T_FLTId);
        ...
        __dtBusInfo[4] = ssGetBusElementOffset(S, __SWLIBS_6Syst_FLTId, 0);
        __dtBusInfo[5] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_FLT.fltArg2 */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __SWLIBS_6Syst_FLTId, 1);
        __dtBusInfo[7] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_FLT.fltArg3 */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __SWLIBS_6Syst_FLTId, 2);
        __dtBusInfo[9] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_FLT.fltArg4 */
        __dtBusInfo[10] = ssGetBusElementOffset(S, __SWLIBS_6Syst_FLTId, 3);
        __dtBusInfo[11] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_FLT.fltArg5 */
        __dtBusInfo[12] = ssGetBusElementOffset(S, __SWLIBS_6Syst_FLTId, 4);
        __dtBusInfo[13] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_FLT.fltArg6 */
        __dtBusInfo[14] = ssGetBusElementOffset(S, __SWLIBS_6Syst_FLTId, 5);
        __dtBusInfo[15] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_CLARK_6PH_T_FLT.fltAlphaD */
        __dtBusInfo[16] = ssGetBusElementOffset(S, __GMCLIB_CLARK_6PH_T_FLTId, 0);
        __dtBusInfo[17] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_CLARK_6PH_T_FLT.fltAlphaE */
        __dtBusInfo[18] = ssGetBusElementOffset(S, __GMCLIB_CLARK_6PH_T_FLTId, 1);
        __dtBusInfo[19] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_CLARK_6PH_T_FLT.fltAlphaF */
        __dtBusInfo[20] = ssGetBusElementOffset(S, __GMCLIB_CLARK_6PH_T_FLTId, 2);
        __dtBusInfo[21] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_CLARK_6PH_T_FLT.fltBetaD */
        __dtBusInfo[22] = ssGetBusElementOffset(S, __GMCLIB_CLARK_6PH_T_FLTId, 3);
        __dtBusInfo[23] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_CLARK_6PH_T_FLT.fltBetaE */
        __dtBusInfo[24] = ssGetBusElementOffset(S, __GMCLIB_CLARK_6PH_T_FLTId, 4);
        __dtBusInfo[25] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_CLARK_6PH_T_FLT.fltBetaF */
        __dtBusInfo[26] = ssGetBusElementOffset(S, __GMCLIB_CLARK_6PH_T_FLTId, 5);
        ...
        {
            SWLIBS_6Syst_FLT* __u1BUS = (SWLIBS_6Syst_FLT*)calloc(sizeof(SWLIBS_6Syst_FLT), ssGetInputPortWidth(S, 0));
            if (__u1BUS==NULL) {
        ...
        {
            GMCLIB_CLARK_6PH_T_FLT* __work1BUS = (GMCLIB_CLARK_6PH_T_FLT*)calloc(sizeof(GMCLIB_CLARK_6PH_T_FLT), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        GMCLIB_CLARK_6PH_T_FLT* __work1BUS = (GMCLIB_CLARK_6PH_T_FLT*) ssGetPWorkValue(S, 2);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].fltAlphaD, work1 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__work1BUS[0].fltAlphaE, work1 +  __dtBusInfo[18],  __dtBusInfo[19]);
        (void) memcpy(&__work1BUS[0].fltAlphaF, work1 +  __dtBusInfo[20],  __dtBusInfo[21]);
        (void) memcpy(&__work1BUS[0].fltBetaD, work1 +  __dtBusInfo[22],  __dtBusInfo[23]);
        (void) memcpy(&__work1BUS[0].fltBetaE, work1 +  __dtBusInfo[24],  __dtBusInfo[25]);
        (void) memcpy(&__work1BUS[0].fltBetaF, work1 +  __dtBusInfo[26],  __dtBusInfo[27]);

        /* Call the legacy code function */
        GMCLIB_Clark6PhInit_w_FLT(__work1BUS, *p1);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[16], &__work1BUS[0].fltAlphaD,  __dtBusInfo[17]);
        (void) memcpy(work1 +  __dtBusInfo[18], &__work1BUS[0].fltAlphaE,  __dtBusInfo[19]);
        (void) memcpy(work1 +  __dtBusInfo[20], &__work1BUS[0].fltAlphaF,  __dtBusInfo[21]);
        (void) memcpy(work1 +  __dtBusInfo[22], &__work1BUS[0].fltBetaD,  __dtBusInfo[23]);
        (void) memcpy(work1 +  __dtBusInfo[24], &__work1BUS[0].fltBetaE,  __dtBusInfo[25]);
        (void) memcpy(work1 +  __dtBusInfo[26], &__work1BUS[0].fltBetaF,  __dtBusInfo[27]);
    } /* if */
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        SWLIBS_6Syst_FLT* __u1BUS = (SWLIBS_6Syst_FLT*) ssGetPWorkValue(S, 1);
        GMCLIB_CLARK_6PH_T_FLT* __work1BUS = (GMCLIB_CLARK_6PH_T_FLT*) ssGetPWorkValue(S, 2);
        ...
        (void) memcpy(&__u1BUS[0].fltArg4, u1 +  __dtBusInfo[10],  __dtBusInfo[11]);
        (void) memcpy(&__u1BUS[0].fltArg5, u1 +  __dtBusInfo[12],  __dtBusInfo[13]);
        (void) memcpy(&__u1BUS[0].fltArg6, u1 +  __dtBusInfo[14],  __dtBusInfo[15]);
        ...
        /* Call the legacy code function */
        GMCLIB_Clark6Ph_w_FLT(__y1BUS, __u1BUS, __work1BUS);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    /* Verify Bus/StructType 'GMCLIB_CLARK_6PH_T_FLT', specification */
    {
        uint32_T chk[] = {1476469853, 556454327, 178620435, 3984354648};
        int_T status;
        status = CheckDataTypeChecksum(S, "GMCLIB_CLARK_6PH_T_FLT", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'GMCLIB_CLARK_6PH_T_FLT'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'GMCLIB_CLARK_6PH_T_FLT' definition has changed since the S-Function was generated");
        }
    }
}
