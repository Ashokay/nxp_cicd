/**
 * GMCLIB_Vmag2coord_SF_FLT.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         single y1 = GMCLIB_Vmag2coord_w_FLT(single u1, single u2)
 *
...
#define S_FUNCTION_NAME  GMCLIB_Vmag2coord_SF_FLT
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GMCLIB_Vmag2coord_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    *y1 = GMCLIB_Vmag2coord_w_FLT(*u1, *u2);
}
