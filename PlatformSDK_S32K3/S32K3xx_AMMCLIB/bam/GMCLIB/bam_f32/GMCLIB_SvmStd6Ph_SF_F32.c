/**
 * GMCLIB_SvmStd6Ph_SF_F32.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void GMCLIB_SvmStd6Ph_w_F32(SWLIBS_6Syst_F32 y1[1], SWLIBS_2Syst_U32 y2[1], SWLIBS_2Syst_F32 u1[1], GMCLIB_SVMSTD_6PH_T_F32 work1[1])
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 12-Sep-2023 09:21:36
 *
 */
...
#define S_FUNCTION_NAME  GMCLIB_SvmStd6Ph_SF_F32
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "GMCLIB_SVMSTD_6PH_T_F32", &dataTypeIdReg);
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "SWLIBS_6Syst_F32", &dataTypeIdReg);
        if(dataTypeIdReg == INVALID_DTYPE_ID) return;

        ssSetOutputPortDataType(S, 0, dataTypeIdReg);
    } /* if */
    #endif
    ssSetBusOutputObjectName(S, 0, (void *)"SWLIBS_6Syst_F32");
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GMCLIB_SvmStd6PhInit_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GMCLIB_SvmStd6Ph_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GMCLIB_SvmStd6PhInit_w_F32_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GMCLIB_SvmStd6Ph_w_F32_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "GMCLIB_SvmStd6Ph_SF_F32_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "GMCLIB_SvmStd6Ph_SF_F32_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        DTypeId __SWLIBS_6Syst_F32Id = ssGetDataTypeId(S, "SWLIBS_6Syst_F32");
        ...
        DTypeId __GMCLIB_SVMSTD_6PH_T_F32Id = ssGetDataTypeId(S, "GMCLIB_SVMSTD_6PH_T_F32");

        /* Get common data type size */
        __dtSizeInfo[0] = ssGetDataTypeSize(S, __SWLIBS_6Syst_F32Id);
        ...
        __dtSizeInfo[4] = ssGetDataTypeSize(S, __SWLIBS_2Syst_F32Id);
        __dtSizeInfo[5] = ssGetDataTypeSize(S, __GMCLIB_SVMSTD_6PH_T_F32Id);

        /* Get information for accessing SWLIBS_6Syst_F32.f32Arg1 */
        __dtBusInfo[0] = ssGetBusElementOffset(S, __SWLIBS_6Syst_F32Id, 0);
        __dtBusInfo[1] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_F32.f32Arg2 */
        __dtBusInfo[2] = ssGetBusElementOffset(S, __SWLIBS_6Syst_F32Id, 1);
        __dtBusInfo[3] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_F32.f32Arg3 */
        __dtBusInfo[4] = ssGetBusElementOffset(S, __SWLIBS_6Syst_F32Id, 2);
        __dtBusInfo[5] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_F32.f32Arg4 */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __SWLIBS_6Syst_F32Id, 3);
        __dtBusInfo[7] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_F32.f32Arg5 */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __SWLIBS_6Syst_F32Id, 4);
        __dtBusInfo[9] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_F32.f32Arg6 */
        __dtBusInfo[10] = ssGetBusElementOffset(S, __SWLIBS_6Syst_F32Id, 5);
        ...
        __dtBusInfo[16] = ssGetBusElementOffset(S, __SWLIBS_2Syst_F32Id, 0);
        __dtBusInfo[17] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_2Syst_F32.f32Arg2 */
        __dtBusInfo[18] = ssGetBusElementOffset(S, __SWLIBS_2Syst_F32Id, 1);
        __dtBusInfo[19] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_SVMSTD_6PH_T_F32.f32AlphaD */
        __dtBusInfo[20] = ssGetBusElementOffset(S, __GMCLIB_SVMSTD_6PH_T_F32Id, 0);
        __dtBusInfo[21] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_SVMSTD_6PH_T_F32.f32AlphaE */
        __dtBusInfo[22] = ssGetBusElementOffset(S, __GMCLIB_SVMSTD_6PH_T_F32Id, 1);
        __dtBusInfo[23] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_SVMSTD_6PH_T_F32.f32AlphaF */
        __dtBusInfo[24] = ssGetBusElementOffset(S, __GMCLIB_SVMSTD_6PH_T_F32Id, 2);
        __dtBusInfo[25] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_SVMSTD_6PH_T_F32.f32BetaD */
        __dtBusInfo[26] = ssGetBusElementOffset(S, __GMCLIB_SVMSTD_6PH_T_F32Id, 3);
        __dtBusInfo[27] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_SVMSTD_6PH_T_F32.f32BetaE */
        __dtBusInfo[28] = ssGetBusElementOffset(S, __GMCLIB_SVMSTD_6PH_T_F32Id, 4);
        __dtBusInfo[29] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_SVMSTD_6PH_T_F32.f32BetaF */
        __dtBusInfo[30] = ssGetBusElementOffset(S, __GMCLIB_SVMSTD_6PH_T_F32Id, 5);
        __dtBusInfo[31] = __dtSizeInfo[1];


        /* Alloc memory for the pwork 1 (__y1BUS) */
        {
            SWLIBS_6Syst_F32* __y1BUS = (SWLIBS_6Syst_F32*)calloc(sizeof(SWLIBS_6Syst_F32), ssGetOutputPortWidth(S, 0));
            if (__y1BUS==NULL) {
        ...
        {
            GMCLIB_SVMSTD_6PH_T_F32* __work1BUS = (GMCLIB_SVMSTD_6PH_T_F32*)calloc(sizeof(GMCLIB_SVMSTD_6PH_T_F32), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        GMCLIB_SVMSTD_6PH_T_F32* __work1BUS = (GMCLIB_SVMSTD_6PH_T_F32*) ssGetPWorkValue(S, 3);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].f32AlphaD, work1 +  __dtBusInfo[20],  __dtBusInfo[21]);
        (void) memcpy(&__work1BUS[0].f32AlphaE, work1 +  __dtBusInfo[22],  __dtBusInfo[23]);
        (void) memcpy(&__work1BUS[0].f32AlphaF, work1 +  __dtBusInfo[24],  __dtBusInfo[25]);
        (void) memcpy(&__work1BUS[0].f32BetaD, work1 +  __dtBusInfo[26],  __dtBusInfo[27]);
        (void) memcpy(&__work1BUS[0].f32BetaE, work1 +  __dtBusInfo[28],  __dtBusInfo[29]);
        (void) memcpy(&__work1BUS[0].f32BetaF, work1 +  __dtBusInfo[30],  __dtBusInfo[31]);

        /* Call the legacy code function */
        GMCLIB_SvmStd6PhInit_w_F32(__work1BUS, *p1);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[20], &__work1BUS[0].f32AlphaD,  __dtBusInfo[21]);
        (void) memcpy(work1 +  __dtBusInfo[22], &__work1BUS[0].f32AlphaE,  __dtBusInfo[23]);
        (void) memcpy(work1 +  __dtBusInfo[24], &__work1BUS[0].f32AlphaF,  __dtBusInfo[25]);
        (void) memcpy(work1 +  __dtBusInfo[26], &__work1BUS[0].f32BetaD,  __dtBusInfo[27]);
        (void) memcpy(work1 +  __dtBusInfo[28], &__work1BUS[0].f32BetaE,  __dtBusInfo[29]);
        (void) memcpy(work1 +  __dtBusInfo[30], &__work1BUS[0].f32BetaF,  __dtBusInfo[31]);
    } /* if */
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        SWLIBS_6Syst_F32* __y1BUS = (SWLIBS_6Syst_F32*) ssGetPWorkValue(S, 0);
        SWLIBS_2Syst_U32* __y2BUS = (SWLIBS_2Syst_U32*) ssGetPWorkValue(S, 1);
        SWLIBS_2Syst_F32* __u1BUS = (SWLIBS_2Syst_F32*) ssGetPWorkValue(S, 2);
        GMCLIB_SVMSTD_6PH_T_F32* __work1BUS = (GMCLIB_SVMSTD_6PH_T_F32*) ssGetPWorkValue(S, 3);

        /* Assign the Simulink structure u1 to user structure __u1BUS */
        (void) memcpy(&__u1BUS[0].f32Arg1, u1 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__u1BUS[0].f32Arg2, u1 +  __dtBusInfo[18],  __dtBusInfo[19]);
        ...
        /* Call the legacy code function */
        GMCLIB_SvmStd6Ph_w_F32(__y1BUS, __y2BUS, __u1BUS, __work1BUS);
        ...
        (void) memcpy(y1 +  __dtBusInfo[6], &__y1BUS[0].f32Arg4,  __dtBusInfo[7]);
        (void) memcpy(y1 +  __dtBusInfo[8], &__y1BUS[0].f32Arg5,  __dtBusInfo[9]);
        (void) memcpy(y1 +  __dtBusInfo[10], &__y1BUS[0].f32Arg6,  __dtBusInfo[11]);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    /* Verify Bus/StructType 'SWLIBS_6Syst_F32', specification */
    {
        uint32_T chk[] = {2019733123, 745042100, 2951934919, 1500161463};
        int_T status;
        status = CheckDataTypeChecksum(S, "SWLIBS_6Syst_F32", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'SWLIBS_6Syst_F32'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'SWLIBS_6Syst_F32' definition has changed since the S-Function was generated");
        }
    }
    ...
    /* Verify Bus/StructType 'GMCLIB_SVMSTD_6PH_T_F32', specification */
    {
        uint32_T chk[] = {2867038624, 2328152582, 3980191194, 602643053};
        int_T status;
        status = CheckDataTypeChecksum(S, "GMCLIB_SVMSTD_6PH_T_F32", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'GMCLIB_SVMSTD_6PH_T_F32'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'GMCLIB_SVMSTD_6PH_T_F32' definition has changed since the S-Function was generated");
        }
    }
}
