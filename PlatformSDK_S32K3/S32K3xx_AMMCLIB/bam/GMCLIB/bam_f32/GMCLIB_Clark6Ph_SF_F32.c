/**
 * GMCLIB_Clark6Ph_SF_F32.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void GMCLIB_Clark6Ph_w_F32(SWLIBS_2Syst_F32 y1[1], SWLIBS_6Syst_F32 u1[1], GMCLIB_CLARK_6PH_T_F32 work1[1])
 *
...
#define S_FUNCTION_NAME  GMCLIB_Clark6Ph_SF_F32
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "GMCLIB_CLARK_6PH_T_F32", &dataTypeIdReg);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GMCLIB_Clark6PhInit_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GMCLIB_Clark6Ph_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GMCLIB_Clark6PhInit_w_F32_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GMCLIB_Clark6Ph_w_F32_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "GMCLIB_Clark6Ph_SF_F32_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "GMCLIB_Clark6Ph_SF_F32_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        DTypeId __GMCLIB_CLARK_6PH_T_F32Id = ssGetDataTypeId(S, "GMCLIB_CLARK_6PH_T_F32");
        ...
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __SWLIBS_6Syst_F32Id);
        __dtSizeInfo[3] = ssGetDataTypeSize(S, __GMCLIB_CLARK_6PH_T_F32Id);
        ...
        __dtBusInfo[4] = ssGetBusElementOffset(S, __SWLIBS_6Syst_F32Id, 0);
        __dtBusInfo[5] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_F32.f32Arg2 */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __SWLIBS_6Syst_F32Id, 1);
        __dtBusInfo[7] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_F32.f32Arg3 */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __SWLIBS_6Syst_F32Id, 2);
        __dtBusInfo[9] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_F32.f32Arg4 */
        __dtBusInfo[10] = ssGetBusElementOffset(S, __SWLIBS_6Syst_F32Id, 3);
        __dtBusInfo[11] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_F32.f32Arg5 */
        __dtBusInfo[12] = ssGetBusElementOffset(S, __SWLIBS_6Syst_F32Id, 4);
        __dtBusInfo[13] = __dtSizeInfo[1];

        /* Get information for accessing SWLIBS_6Syst_F32.f32Arg6 */
        __dtBusInfo[14] = ssGetBusElementOffset(S, __SWLIBS_6Syst_F32Id, 5);
        __dtBusInfo[15] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_CLARK_6PH_T_F32.f32AlphaD */
        __dtBusInfo[16] = ssGetBusElementOffset(S, __GMCLIB_CLARK_6PH_T_F32Id, 0);
        __dtBusInfo[17] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_CLARK_6PH_T_F32.f32AlphaE */
        __dtBusInfo[18] = ssGetBusElementOffset(S, __GMCLIB_CLARK_6PH_T_F32Id, 1);
        __dtBusInfo[19] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_CLARK_6PH_T_F32.f32AlphaF */
        __dtBusInfo[20] = ssGetBusElementOffset(S, __GMCLIB_CLARK_6PH_T_F32Id, 2);
        __dtBusInfo[21] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_CLARK_6PH_T_F32.f32BetaD */
        __dtBusInfo[22] = ssGetBusElementOffset(S, __GMCLIB_CLARK_6PH_T_F32Id, 3);
        __dtBusInfo[23] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_CLARK_6PH_T_F32.f32BetaE */
        __dtBusInfo[24] = ssGetBusElementOffset(S, __GMCLIB_CLARK_6PH_T_F32Id, 4);
        __dtBusInfo[25] = __dtSizeInfo[1];

        /* Get information for accessing GMCLIB_CLARK_6PH_T_F32.f32BetaF */
        __dtBusInfo[26] = ssGetBusElementOffset(S, __GMCLIB_CLARK_6PH_T_F32Id, 5);
        ...
        {
            SWLIBS_6Syst_F32* __u1BUS = (SWLIBS_6Syst_F32*)calloc(sizeof(SWLIBS_6Syst_F32), ssGetInputPortWidth(S, 0));
            if (__u1BUS==NULL) {
        ...
        {
            GMCLIB_CLARK_6PH_T_F32* __work1BUS = (GMCLIB_CLARK_6PH_T_F32*)calloc(sizeof(GMCLIB_CLARK_6PH_T_F32), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        GMCLIB_CLARK_6PH_T_F32* __work1BUS = (GMCLIB_CLARK_6PH_T_F32*) ssGetPWorkValue(S, 2);
        ...
        GMCLIB_Clark6PhInit_w_F32(__work1BUS, *p1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        SWLIBS_6Syst_F32* __u1BUS = (SWLIBS_6Syst_F32*) ssGetPWorkValue(S, 1);
        GMCLIB_CLARK_6PH_T_F32* __work1BUS = (GMCLIB_CLARK_6PH_T_F32*) ssGetPWorkValue(S, 2);
        ...
        (void) memcpy(&__u1BUS[0].f32Arg4, u1 +  __dtBusInfo[10],  __dtBusInfo[11]);
        (void) memcpy(&__u1BUS[0].f32Arg5, u1 +  __dtBusInfo[12],  __dtBusInfo[13]);
        (void) memcpy(&__u1BUS[0].f32Arg6, u1 +  __dtBusInfo[14],  __dtBusInfo[15]);
        ...
        /* Call the legacy code function */
        GMCLIB_Clark6Ph_w_F32(__y1BUS, __u1BUS, __work1BUS);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    /* Verify Bus/StructType 'GMCLIB_CLARK_6PH_T_F32', specification */
    {
        uint32_T chk[] = {2867038624, 2328152582, 3980191194, 602643053};
        int_T status;
        status = CheckDataTypeChecksum(S, "GMCLIB_CLARK_6PH_T_F32", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'GMCLIB_CLARK_6PH_T_F32'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'GMCLIB_CLARK_6PH_T_F32' definition has changed since the S-Function was generated");
        }
    }
}
