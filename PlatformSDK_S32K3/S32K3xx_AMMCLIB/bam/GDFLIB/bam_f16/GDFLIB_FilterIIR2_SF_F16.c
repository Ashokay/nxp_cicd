 ...
 *    C source code generated on : 12-Sep-2023 09:21:09
 *
 */
    ...
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p12) == 1) {
          ...
          *p3=(int16_T)f16B1_tmp;
          f16B2_tmp=b2sc*32768.0;
          if(f16B2_tmp>32767.0) {
            f16B2_tmp=32767.0;
          }
          if(f16B2_tmp<-32768.0) {
            f16B2_tmp=-32768.0;
          }
          *p4=(int16_T)f16B2_tmp;
          ...
          *p5=(int16_T)f16A1_tmp;
          f16A2_tmp=a2sc*32768.0;
          if(f16A2_tmp>32767.0) {
            f16A2_tmp=32767.0;
          }
          if(f16A2_tmp<-32768.0) {
            f16A2_tmp=-32768.0;
          }
          *p6=(int16_T)f16A2_tmp;
        }
        GDFLIB_FilterIIR2Init_w_F16(*p2, *p3, *p4, *p5, *p6, __work1BUS, *p7, *p8, *p9, *p10, *p11, *p12);
