...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p12) == 1) {
          ...
          a1sc=(*p10)/8.0;
          a2sc=(*p11)/8.0;
          f32B0_tmp=b0sc*2147483648.0;
          if(f32B0_tmp>2147483647.0) {
            f32B0_tmp=2147483647.0;
          }
          if(f32B0_tmp<-2147483648.0) {
            f32B0_tmp=-2147483648.0;
          }
          *p2=(int32_T)f32B0_tmp;
          f32B1_tmp=b1sc*2147483648.0;
          if(f32B1_tmp>2147483647.0) {
            f32B1_tmp=2147483647.0;
          }
          if(f32B1_tmp<-2147483648.0) {
            f32B1_tmp=-2147483648.0;
          }
          *p3=(int32_T)f32B1_tmp;
          f32B2_tmp=b2sc*2147483648.0;
          if(f32B2_tmp>2147483647.0) {
            f32B2_tmp=2147483647.0;
          }
          if(f32B2_tmp<-2147483648.0) {
            f32B2_tmp=-2147483648.0;
          }
          *p4=(int32_T)f32B2_tmp;
          f32A1_tmp=a1sc*2147483648.0;
          if(f32A1_tmp>2147483647.0) {
            f32A1_tmp=2147483647.0;
          }
          if(f32A1_tmp<-2147483648.0) {
            f32A1_tmp=-2147483648.0;
          }
          *p5=(int32_T)f32A1_tmp;
          f32A2_tmp=a2sc*2147483648.0;
          if(f32A2_tmp>2147483647.0) {
            f32A2_tmp=2147483647.0;
          }
          if(f32A2_tmp<-2147483648.0) {
            f32A2_tmp=-2147483648.0;
          }
          *p6=(int32_T)f32A2_tmp;
        }
        GDFLIB_FilterIIR2Init_w_F32(*p2, *p3, *p4, *p5, *p6, __work1BUS, *p7, *p8, *p9, *p10, *p11, *p12);
