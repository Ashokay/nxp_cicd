/**
 * MLIB_DivSatAccurate_SF_F32.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         int32 y1 = MLIB_DivSatAccurate_w_F32(int32 u1, int32 u2)
 *
...
#define S_FUNCTION_NAME  MLIB_DivSatAccurate_SF_F32
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "MLIB_DivSatAccurate_w_F32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    *y1 = MLIB_DivSatAccurate_w_F32(*u1, *u2);
}
