...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    if (!ssSetNumRunTimeParams(S, 30)) return;
    ...
    ssRegDlgParamAsRunTimeParam(S, 28, 28, "p29", ssGetDataTypeId(S, "int32"));

    /* Register the run-time parameter 30 */
    ssRegDlgParamAsRunTimeParam(S, 29, 29, "p30", ssGetDataTypeId(S, "int32"));
}
#endif
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        int32_T* p30 = (int32_T*) ssGetRunTimeParamInfo(S, 29)->data;
        ...
        if((*p30) == 1) {
          w0=6.283185307179586*(*p17);
          pgain=2.0*(*p18)*w0*(*p19)/(*p20);
          igain=w0*w0*(*p19)/(*p20);
          wmax=(*p28)*(*p27)*0.1047197551196598;
          *p7=pgain;
          *p8=igain*SampleTime*0.5;
          *p9=-wmax;
          *p10=wmax;
          *p11=0.9*pgain;
          *p12=(*p8);
          if((*p23)<0) {
            ...
            lowlim=acos(iratio)-1.570796326794897;
          } else {
            lowlim=0.0;
          }
          *p13=lowlim;
          ...
          *p5=(*p21);
          *p6=(*p22);
          rampsc=(*p28)*fabs((*p26))*0.1047197551196598;
          *p15=rampsc;
          *p16=rampsc;
          *p4=0.5773502691896258*(*p25)/(*p24);
        }
        AMCLIB_FWSpeedLoopInit_w_FLT(__work1BUS, __work2BUS, __work3BUS, __work4BUS, __work5BUS, __work6BUS, work7, work8, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11, *p12, *p13, *p14, *p15, *p16, *p1, *p2, *p3, *p17, *p18, *p19, *p20, *p21, *p22, *p23, *p24, *p25, *p26, *p27, *p28, *p30);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        int32_T* p2 = (int32_T*) ssGetRunTimeParamInfo(S, 1)->data;
        int32_T* p3 = (int32_T*) ssGetRunTimeParamInfo(S, 2)->data;
        int32_T* p29 = (int32_T*) ssGetRunTimeParamInfo(S, 28)->data;
