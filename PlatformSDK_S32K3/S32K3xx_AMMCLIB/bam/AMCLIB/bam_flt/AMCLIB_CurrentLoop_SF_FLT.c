...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p13) == 1) {
          w0=6.283185307179586*(*p8);
          pgainD=2.0*(*p9)*w0*(*p10)-(*p12);
          igainD=w0*w0*(*p10);
          pgainQ=2.0*(*p9)*w0*(*p11)-(*p12);
          igainQ=w0*w0*(*p11);
          if((*p7) == 1) {
            cc1d=pgainD;
        ...
        AMCLIB_CurrentLoopInit_w_FLT(__work1BUS, __work2BUS, work3, *p3, *p4, *p5, *p6, *p2, *p7, *p8, *p9, *p10, *p11, *p12, *p13);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        AMCLIB_CurrentLoop_w_FLT(*u1, __work1BUS, __work2BUS, __u2BUS, __u3BUS, work3, *u4, *u5, *u6, *u7, *u8, *u9, *u10, *u11, *u12, *u13, __y1BUS, y2, y3, y4, y5, y6, *p1, *p2);
