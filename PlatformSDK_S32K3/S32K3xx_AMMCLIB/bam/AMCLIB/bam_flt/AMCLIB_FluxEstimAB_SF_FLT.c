/**
 * AMCLIB_FluxEstimAB_SF_FLT.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         single y1 = AMCLIB_FluxEstimAB_w_FLT(single u1, SWLIBS_2Syst_FLT u2[1], SWLIBS_2Syst_FLT u3[1], single u4, single u5, int32 p1, AMCLIB_FLUXESTIMAB_T_FLT work1[1])
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 12-Sep-2023 09:22:05
 *
 */
...
#define S_FUNCTION_NAME  AMCLIB_FluxEstimAB_SF_FLT
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "AMCLIB_FLUXESTIMAB_T_FLT", &dataTypeIdReg);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "AMCLIB_FluxEstimABInit_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "AMCLIB_FluxEstimAB_w_FLT", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_FluxEstimABInit_w_FLT_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_FluxEstimAB_w_FLT_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_FluxEstimAB_SF_FLT_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_FluxEstimAB_SF_FLT_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __AMCLIB_FLUXESTIMAB_T_FLTId);
        ...
        /* Get information for accessing AMCLIB_FLUXESTIMAB_T_FLT.fltRs */
        __dtBusInfo[4] = ssGetBusElementOffset(S, __AMCLIB_FLUXESTIMAB_T_FLTId, 0);
        __dtBusInfo[5] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_FLUXESTIMAB_T_FLT.fltLs */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __AMCLIB_FLUXESTIMAB_T_FLTId, 1);
        ...
        {
            AMCLIB_FLUXESTIMAB_T_FLT* __work1BUS = (AMCLIB_FLUXESTIMAB_T_FLT*)calloc(sizeof(AMCLIB_FLUXESTIMAB_T_FLT), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        AMCLIB_FLUXESTIMAB_T_FLT* __work1BUS = (AMCLIB_FLUXESTIMAB_T_FLT*) ssGetPWorkValue(S, 2);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].fltRs, work1 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work1BUS[0].fltLs, work1 +  __dtBusInfo[6],  __dtBusInfo[7]);

        /* Call the legacy code function */
        AMCLIB_FluxEstimABInit_w_FLT(*p2, *p3, __work1BUS);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[4], &__work1BUS[0].fltRs,  __dtBusInfo[5]);
        (void) memcpy(work1 +  __dtBusInfo[6], &__work1BUS[0].fltLs,  __dtBusInfo[7]);
    } /* if */
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        SWLIBS_2Syst_FLT* __u2BUS = (SWLIBS_2Syst_FLT*) ssGetPWorkValue(S, 0);
        SWLIBS_2Syst_FLT* __u3BUS = (SWLIBS_2Syst_FLT*) ssGetPWorkValue(S, 1);
        AMCLIB_FLUXESTIMAB_T_FLT* __work1BUS = (AMCLIB_FLUXESTIMAB_T_FLT*) ssGetPWorkValue(S, 2);
        ...
        /* Call the legacy code function */
        *y1 = AMCLIB_FluxEstimAB_w_FLT(*u1, __u2BUS, __u3BUS, *u4, *u5, *p1, __work1BUS);
