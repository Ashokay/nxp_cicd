...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p20) == 1) {
          ...
          *p5=pgain;
          *p6=igain*SampleTime*0.5;
          *p7=-wmax;
          *p8=wmax;
          *p4=(*p15);
          rampsc=(*p18)*fabs((*p16))*0.1047197551196598;
          *p9=rampsc;
          *p10=rampsc;
        }
        AMCLIB_SpeedLoopInit_w_FLT(__work1BUS, __work2BUS, __work3BUS, work4, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p1, *p2, *p3, *p11, *p12, *p13, *p14, *p15, *p16, *p17, *p18, *p20);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        AMCLIB_SpeedLoop_w_FLT(*u1, *u2, __work1BUS, __work2BUS, __work3BUS, work4, *u3, *u4, *u5, *u6, *u7, *u8, *u9, *u10, *u11, *u12, *u13, *u14, *u15, *u16, __y1BUS, y2, y3, y4, y5, y6, y7, y8, y9, *p1, *p2, *p3, *p19);
