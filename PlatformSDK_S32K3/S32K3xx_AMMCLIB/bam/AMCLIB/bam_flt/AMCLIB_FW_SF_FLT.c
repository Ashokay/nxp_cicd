 ...
 *    C source code generated on : 12-Sep-2023 09:22:33
 *
 */
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p18) == 1) {
          ...
          pgain=2.0*(*p11)*w0*(*p12)/(*p13);
          igain=w0*w0*(*p12)/(*p13);
          *p6=0.9*pgain;
          *p7=igain*SampleTime*0.5;
          if((*p15)<0) {
            iratio=fabs((*p15))/(*p16);
            if(fabs(iratio) > 1) {
              iratio = 0;
          ...
          *p9=0.0;
          *p5=(*p14);
          *p4=0.5773502691896258*(*p17)/(*p16);
        }
        AMCLIB_FWInit_w_FLT(__work1BUS, __work2BUS, __work3BUS, work4, work5, *p4, *p5, *p6, *p7, *p8, *p9, *p1, *p2, *p3, *p10, *p11, *p12, *p13, *p14, *p15, *p16, *p17, *p18);
