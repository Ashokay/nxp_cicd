 ...
 *    C source code generated on : 12-Sep-2023 09:21:52
 *
 */
...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    if (!ssSetNumRunTimeParams(S, 23)) return;
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p23) == 1) {
          w0=6.283185307179586*(*p16);
          pgain=2.0*(*p17)*w0*(*p18)-(*p20);
          igain=w0*w0*(*p18);
          if((*p15) == 1) {
            cc1=pgain;
          ...
          *p14=(*p10);
          *p13=(*p9);
          *p3=(2.0*(*p18)-SampleTime*(*p20))/(2.0*(*p18)+SampleTime*(*p20));
          *p4=SampleTime/(2.0*(*p18)+SampleTime*(*p20));
          *p5=SampleTime*(*p19)/(2.0*(*p18)+SampleTime*(*p20));
          *p6=SampleTime/(2.0*(*p18)+SampleTime*(*p20));
        }
        AMCLIB_BemfObsrvDQInit_w_FLT(__work1BUS, work2, *p3, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11, *p12, *p13, *p14, *p2, *p15, *p16, *p17, *p18, *p19, *p20, *p21, *p22, *p23);
