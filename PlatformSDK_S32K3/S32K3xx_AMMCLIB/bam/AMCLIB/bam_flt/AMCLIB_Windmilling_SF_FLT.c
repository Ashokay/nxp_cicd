 ...
 *    C source code generated on : 12-Sep-2023 09:21:47
 *
 */
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p11) == 1) {
          *p2=(*p10);
          pgain=12.56637061435917*(*p9)*(*p8);
          igain=39.47841760435743*(*p8)*(*p8);
        ...
        AMCLIB_WindmillingInit_w_FLT(__work1BUS, *p2, *p3, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11);
