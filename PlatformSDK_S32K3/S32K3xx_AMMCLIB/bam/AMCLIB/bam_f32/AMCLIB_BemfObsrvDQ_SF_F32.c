 ...
 *    C source code generated on : 12-Sep-2023 09:21:29
 *
 */
...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    if (!ssSetNumRunTimeParams(S, 28)) return;
    ...
    ssRegDlgParamAsRunTimeParam(S, 27, 27, "p28", ssGetDataTypeId(S, "int32"));
}
#endif
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        double f32CC1sc_D_tmp;
        double f32CC2sc_D_tmp;
        double wmax;
        double igainsc;
        double ugainsc;
        double wigainsc;
        ...
        int32_T* p28 = (int32_T*) ssGetRunTimeParamInfo(S, 27)->data;
        ...
        if((*p28) == 1) {
          w0=6.283185307179586*(*p18);
          pgain=2.0*(*p19)*w0*(*p20)-(*p22);
          igain=w0*w0*(*p20);
          if((*p17) == 1) {
            cc1=pgain;
            cc2=-pgain+igain*SampleTime;
          } else {
            if((*p17) == 2) {
              cc1=pgain+igain*SampleTime;
              cc2=-pgain;
            } else {
              cc1=pgain+igain*SampleTime*0.5;
              cc2=-pgain+igain*SampleTime*0.5;
            }
          }
          cc1f=cc1*(*p27)/(*p26);
          cc2f=cc2*(*p27)/(*p26);
          u16NShift_tmp=ceil(M_LOG2E*log(fabs((double)cc1f)));
          u16NShift_tmp2=ceil(M_LOG2E*log(fabs((double)cc2f)));
          ...
          *p16=(uint16_T)u16NShift_tmp;
          f32CC1sc_D_tmp=cc1f*2147483648.0/(double)(1UL << (*p16));
          if(f32CC1sc_D_tmp>2147483647.0) {
            f32CC1sc_D_tmp=2147483647.0;
          }
          if(f32CC1sc_D_tmp<-2147483648.0) {
            f32CC1sc_D_tmp=-2147483648.0;
          }
          *p8=(int32_T)f32CC1sc_D_tmp;
          f32CC2sc_D_tmp=cc2f*2147483648.0/(double)(1UL << (*p16));
          if(f32CC2sc_D_tmp>2147483647.0) {
            f32CC2sc_D_tmp=2147483647.0;
          }
          if(f32CC2sc_D_tmp<-2147483648.0) {
            f32CC2sc_D_tmp=-2147483648.0;
          }
          *p9=(int32_T)f32CC2sc_D_tmp;
          *p11=-2147483648;
          *p10=2147483647;
          *p12=(*p8);
          *p13=(*p9);
          *p15=(*p11);
          *p14=(*p10);
          wmax=(*p24)*(*p23)*1.047197551196598e-01;
          igainsc=(2.0*(*p20)-SampleTime*(*p22))/(2.0*(*p20)+SampleTime*(*p22));
          ugainsc=SampleTime/(2.0*(*p20)+SampleTime*(*p22))*(*p25)/(*p27);
          wigainsc=SampleTime*(*p21)/(2.0*(*p20)+SampleTime*(*p22))*wmax;
          egainsc=SampleTime/(2.0*(*p20)+SampleTime*(*p22))*(*p26)/(*p27);
          maxgain=fabs((double)ugainsc);
          wigainsc_tmp=fabs((double)wigainsc);
          egainsc_tmp=fabs((double)egainsc);
          if(wigainsc_tmp>maxgain) {
            maxgain=wigainsc_tmp;
          }
          if(egainsc_tmp>maxgain) {
            maxgain=egainsc_tmp;
          }
          s16Shift_tmp=ceil(M_LOG2E*log(fabs((double)maxgain)));
          if(s16Shift_tmp<-31) {
            s16Shift_tmp=-31;
          }
          if(s16Shift_tmp>31) {
          ...
          *p7=(int16_T)s16Shift_tmp;
          f32IGain_tmp=igainsc*2147483648.0;
          if(f32IGain_tmp>2147483647.0) {
            f32IGain_tmp=2147483647.0;
          }
          if(f32IGain_tmp<-2147483648.0) {
            f32IGain_tmp=-2147483648.0;
          }
          *p3=(int32_T)f32IGain_tmp;
          if((*p7)<0) {
            f32UGain_tmp=ugainsc*2147483648.0*(double)(1UL << (-(*p7)));
          } else {
            f32UGain_tmp=ugainsc*2147483648.0/(double)(1UL << (*p7));
          }
          if(f32UGain_tmp>2147483647.0) {
            f32UGain_tmp=2147483647.0;
          }
          if(f32UGain_tmp<-2147483648.0) {
            f32UGain_tmp=-2147483648.0;
          }
          *p4=(int32_T)f32UGain_tmp;
          if((*p7)<0) {
            f32WIGain_tmp=wigainsc*2147483648.0*(double)(1UL << (-(*p7)));
          } else {
            f32WIGain_tmp=wigainsc*2147483648.0/(double)(1UL << (*p7));
          }
          if(f32WIGain_tmp>2147483647.0) {
            f32WIGain_tmp=2147483647.0;
          }
          if(f32WIGain_tmp<-2147483648.0) {
            f32WIGain_tmp=-2147483648.0;
          }
          *p5=(int32_T)f32WIGain_tmp;
          if((*p7)<0) {
            f32EGain_tmp=egainsc*2147483648.0*(double)(1UL << (-(*p7)));
          } else {
            f32EGain_tmp=egainsc*2147483648.0/(double)(1UL << (*p7));
          }
          if(f32EGain_tmp>2147483647.0) {
            f32EGain_tmp=2147483647.0;
          }
          if(f32EGain_tmp<-2147483648.0) {
            f32EGain_tmp=-2147483648.0;
          }
          *p6=(int32_T)f32EGain_tmp;
        }
        AMCLIB_BemfObsrvDQInit_w_F32(__work1BUS, work2, *p3, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11, *p12, *p13, *p14, *p15, *p16, *p2, *p17, *p18, *p19, *p20, *p21, *p22, *p23, *p24, *p25, *p26, *p27, *p28);
