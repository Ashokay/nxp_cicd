 ...
 *    C source code generated on : 12-Sep-2023 09:22:09
 *
 */
...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    if (!ssSetNumRunTimeParams(S, 21)) return;
    ...
    ssRegDlgParamAsRunTimeParam(S, 20, 20, "p21", ssGetDataTypeId(S, "int32"));
}
#endif
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        int32_T* p21 = (int32_T*) ssGetRunTimeParamInfo(S, 20)->data;
        ...
        if((*p21) == 1) {
          ...
          pgain=2.0*(*p12)*w0*(*p13)/(*p14);
          igain=w0*w0*(*p13)/(*p14);
          wmax=(*p18)*(*p17)*0.1047197551196598;
          kif=igain*SampleTime*0.5*wmax/(*p20);
          fwkpf=0.9*pgain*wmax/(*p20);
          s16PropGainShift_tmp=ceil(M_LOG2E*log(fabs((double)fwkpf)));
          ...
          *p7=(int16_T)s16PropGainShift_tmp;
          if((*p7)<0) {
            f32PropGain_tmp=fwkpf*2147483648.0*(double)(1UL << (-(*p7)));
          } else {
            f32PropGain_tmp=fwkpf*2147483648.0/(double)(1UL << (*p7));
          }
          ...
          *p6=(int32_T)f32IntegGain_tmp;
          ...
          f32LowerLimit_tmp=lowlim*2147483648.0;
          ...
          *p9=(int32_T)f32LowerLimit_tmp;
          *p10=0;
          u16NSamples_tmp=round(M_LOG2E*log(1.0/fabs((*p15))));
          if(u16NSamples_tmp>31.0) {
            u16NSamples_tmp=31.0;
          }
          if(u16NSamples_tmp<0.0) {
            u16NSamples_tmp=0.0;
          }
          *p4=(uint16_T)u16NSamples_tmp;
        }
        AMCLIB_FWInit_w_F32(__work1BUS, __work2BUS, __work3BUS, work4, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p1, *p2, *p3, *p11, *p12, *p13, *p14, *p15, *p16, *p17, *p18, *p19, *p20, *p21);
