 ...
 *
 *         void AMCLIB_FWSpeedLoop_w_F32(int32 u1, int32 u2, SWLIBS_2Syst_F32 work1[1], GDFLIB_FILTER_MA_T_F32 work2[1], GDFLIB_FILTER_MA_T_F32 work3[1], GFLIB_CONTROLLER_PIAW_P_T_F32 work4[1], GFLIB_CONTROLLER_PIAW_P_T_F32 work5[1], GFLIB_RAMP_T_F32 work6[1], int32 work7[1], int32 u3[1], int32 u4[1], int32 u5[1], int32 u6, int32 u7, int32 u8, int32 u9, int32 u10, uint16 u11, uint16 u12, int32 u13, int32 u14, int16 u15, int16 u16, int32 u17, int32 u18, int32 u19, int32 u20, int16 u21, int16 u22, int32 u23, int32 u24, int32 u25, int32 u26, int32 u27, int32 u28, int32 u29, int32 u30, int32 u31, int32 u32, int32 u33, int32 u34, SWLIBS_2Syst_F32 y1[1], uint16 y2[1], uint16 y3[1], int32 y4[1], int32 y5[1], int32 y6[1], int32 y7[1], int32 y8[1], int32 y9[1], int32 y10[1], int32 y11[1], int32 y12[1], int32 y13[1], int32 y14[1], int32 y15[1], int32 y16[1], int32 y17[1], int32 y18[1], int32 y19[1], int32 y20[1], int32 y21[1], int32 y22[1], int32 p1, int32 p2, int32 p3, int32 p32)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 12-Sep-2023 09:21:04
 *
 */
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        double f32PropGainFW_tmp;
        double iratio;
        double lowlim;
        double f32LowerLimitFW_tmp;
        ...
        if((*p33) == 1) {
          ...
          *p8=(int16_T)s16PropGainShiftQ_tmp;
          if((*p8)<0) {
            f32PropGainQ_tmp=kpf*2147483648.0*(double)(1UL << (-(*p8)));
          } else {
            f32PropGainQ_tmp=kpf*2147483648.0/(double)(1UL << (*p8));
          }
          ...
          *p9=(int16_T)s16IntegGainShiftQ_tmp;
          if((*p9)<0) {
            f32IntegGainQ_tmp=kif*2147483648.0*(double)(1UL << (-(*p9)));
          } else {
            f32IntegGainQ_tmp=kif*2147483648.0/(double)(1UL << (*p9));
          }
          ...
          *p7=(int32_T)f32IntegGainQ_tmp;
          *p10=-2147483648;
          *p11=2147483647;
          fwkpf=0.9*pgain*wmax/(*p31);
          s16PropGainShiftFW_tmp=ceil(M_LOG2E*log(fabs((double)fwkpf)));
          if(s16PropGainShiftFW_tmp<-31) {
            s16PropGainShiftFW_tmp=-31;
          }
          if(s16PropGainShiftFW_tmp>31) {
            s16PropGainShiftFW_tmp=31;
          }
          *p14=(int16_T)s16PropGainShiftFW_tmp;
          if((*p14)<0) {
            f32PropGainFW_tmp=fwkpf*2147483648.0*(double)(1UL << (-(*p14)));
          } else {
            f32PropGainFW_tmp=fwkpf*2147483648.0/(double)(1UL << (*p14));
          }
          if(f32PropGainFW_tmp>2147483647.0) {
            f32PropGainFW_tmp=2147483647.0;
          }
          if(f32PropGainFW_tmp<-2147483648.0) {
            f32PropGainFW_tmp=-2147483648.0;
          }
          *p12=(int32_T)f32PropGainFW_tmp;
          *p15=(*p9);
          *p13=(*p7);
          if((*p26)<0) {
            iratio=fabs((*p26))/(*p31);
          ...
          f32LowerLimitFW_tmp=lowlim*2147483648.0;
          if(f32LowerLimitFW_tmp>2147483647.0) {
            f32LowerLimitFW_tmp=2147483647.0;
          }
          if(f32LowerLimitFW_tmp<-2147483648.0) {
            f32LowerLimitFW_tmp=-2147483648.0;
          }
          *p16=(int32_T)f32LowerLimitFW_tmp;
          *p17=0;
          ...
          *p4=(uint16_T)u16NSamplesW_tmp;
          ...
          if(u16NSamplesFW_tmp>31.0) {
            u16NSamplesFW_tmp=31.0;
          }
        ...
        AMCLIB_FWSpeedLoopInit_w_F32(__work1BUS, __work2BUS, __work3BUS, __work4BUS, __work5BUS, __work6BUS, work7, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11, *p12, *p13, *p14, *p15, *p16, *p17, *p18, *p19, *p1, *p2, *p3, *p20, *p21, *p22, *p23, *p24, *p25, *p26, *p27, *p28, *p29, *p30, *p31, *p33);
