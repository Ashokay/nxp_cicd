...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p15) == 1) {
          pgain=12.56637061435917*(*p12)*(*p11);
          igain=39.47841760435743*(*p11)*(*p11);
          if((*p10) == 1) {
            cc1=pgain;
          ...
          wmax=(*p14)*(*p13)*0.1047197551196598;
        ...
        AMCLIB_TrackObsrvInit_w_F32(__work1BUS, work2, *p3, *p4, *p5, *p6, *p7, *p8, *p9, *p2, *p10, *p11, *p12, *p13, *p14, *p15);
