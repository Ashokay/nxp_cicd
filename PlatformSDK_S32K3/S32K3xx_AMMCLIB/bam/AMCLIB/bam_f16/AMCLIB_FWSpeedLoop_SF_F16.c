...
static void mdlCheckParameters(SimStruct *S)
{
    ...
    /* Check the parameter 25 */
    if (EDIT_OK(S, 24)) {
        int_T dimsArray[2] = {1, 1};

        /* Check the parameter attributes */
        ssCheckSFcnParamValueAttribs(S, 24, "P25", DYNAMICALLY_TYPED, 2, dimsArray, 0);
    } /* if */

    /* Check the parameter 26 */
    if (EDIT_OK(S, 25)) {
        int_T dimsArray[2] = {1, 1};

        /* Check the parameter attributes */
        ssCheckSFcnParamValueAttribs(S, 25, "P26", DYNAMICALLY_TYPED, 2, dimsArray, 0);
    } /* if */

    /* Check the parameter 27 */
    if (EDIT_OK(S, 26)) {
        int_T dimsArray[2] = {1, 1};

        /* Check the parameter attributes */
        ssCheckSFcnParamValueAttribs(S, 26, "P27", DYNAMICALLY_TYPED, 2, dimsArray, 0);
    } /* if */

    /* Check the parameter 28 */
    if (EDIT_OK(S, 27)) {
        int_T dimsArray[2] = {1, 1};

        /* Check the parameter attributes */
        ssCheckSFcnParamValueAttribs(S, 27, "P28", DYNAMICALLY_TYPED, 2, dimsArray, 0);
    } /* if */

    /* Check the parameter 29 */
    if (EDIT_OK(S, 28)) {
        int_T dimsArray[2] = {1, 1};

        /* Check the parameter attributes */
        ssCheckSFcnParamValueAttribs(S, 28, "P29", DYNAMICALLY_TYPED, 2, dimsArray, 0);
    } /* if */

    /* Check the parameter 30 */
    if (EDIT_OK(S, 29)) {
        int_T dimsArray[2] = {1, 1};

        /* Check the parameter attributes */
        ssCheckSFcnParamValueAttribs(S, 29, "P30", DYNAMICALLY_TYPED, 2, dimsArray, 0);
    } /* if */

    /* Check the parameter 31 */
    if (EDIT_OK(S, 30)) {
        int_T dimsArray[2] = {1, 1};

        /* Check the parameter attributes */
        ssCheckSFcnParamValueAttribs(S, 30, "P31", DYNAMICALLY_TYPED, 2, dimsArray, 0);
    } /* if */

    /* Check the parameter 32 */
    if (EDIT_OK(S, 31)) {
        int_T dimsArray[2] = {1, 1};

        /* Check the parameter attributes */
        ssCheckSFcnParamValueAttribs(S, 31, "P32", DYNAMICALLY_TYPED, 2, dimsArray, 0);
    } /* if */

    /* Check the parameter 33 */
    if (EDIT_OK(S, 32)) {
        int_T dimsArray[2] = {1, 1};

        /* Check the parameter attributes */
        ssCheckSFcnParamValueAttribs(S, 32, "P33", DYNAMICALLY_TYPED, 2, dimsArray, 0);
    } /* if */
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    ssSetSFcnParamTunable(S, 24, 1);
    ssSetSFcnParamTunable(S, 25, 1);
    ssSetSFcnParamTunable(S, 26, 1);
    ssSetSFcnParamTunable(S, 27, 1);
    ssSetSFcnParamTunable(S, 28, 1);
    ssSetSFcnParamTunable(S, 29, 1);
    ssSetSFcnParamTunable(S, 30, 1);
    ssSetSFcnParamTunable(S, 31, 1);
    ssSetSFcnParamTunable(S, 32, 1);
...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    if (!ssSetNumRunTimeParams(S, 33)) return;
    ...
    ssRegDlgParamAsRunTimeParam(S, 22, 22, "p23", ssGetDataTypeId(S, "double"));

    /* Register the run-time parameter 24 */
    ssRegDlgParamAsRunTimeParam(S, 23, 23, "p24", ssGetDataTypeId(S, "double"));

    /* Register the run-time parameter 25 */
    ssRegDlgParamAsRunTimeParam(S, 24, 24, "p25", ssGetDataTypeId(S, "double"));

    /* Register the run-time parameter 26 */
    ssRegDlgParamAsRunTimeParam(S, 25, 25, "p26", ssGetDataTypeId(S, "double"));

    /* Register the run-time parameter 27 */
    ssRegDlgParamAsRunTimeParam(S, 26, 26, "p27", ssGetDataTypeId(S, "double"));

    /* Register the run-time parameter 28 */
    ssRegDlgParamAsRunTimeParam(S, 27, 27, "p28", ssGetDataTypeId(S, "double"));

    /* Register the run-time parameter 29 */
    ssRegDlgParamAsRunTimeParam(S, 28, 28, "p29", ssGetDataTypeId(S, "double"));

    /* Register the run-time parameter 30 */
    ssRegDlgParamAsRunTimeParam(S, 29, 29, "p30", ssGetDataTypeId(S, "double"));

    /* Register the run-time parameter 31 */
    ssRegDlgParamAsRunTimeParam(S, 30, 30, "p31", ssGetDataTypeId(S, "double"));

    /* Register the run-time parameter 32 */
    ssRegDlgParamAsRunTimeParam(S, 31, 31, "p32", ssGetDataTypeId(S, "int32"));

    /* Register the run-time parameter 33 */
    ssRegDlgParamAsRunTimeParam(S, 32, 32, "p33", ssGetDataTypeId(S, "int32"));
}
#endif
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        double f16PropGainQ_tmp;
        double kif;
        double s16IntegGainShiftQ_tmp;
        double f16IntegGainQ_tmp;
        double fwkpf;
        double s16PropGainShiftFW_tmp;
        double f16PropGainFW_tmp;
        double iratio;
        double lowlim;
        double f16LowerLimitFW_tmp;
        double u16NSamplesW_tmp;
        double u16NSamplesFW_tmp;
        double rampsc;
        ...
        real_T* p23 = (real_T*) ssGetRunTimeParamInfo(S, 22)->data;
        real_T* p24 = (real_T*) ssGetRunTimeParamInfo(S, 23)->data;
        real_T* p25 = (real_T*) ssGetRunTimeParamInfo(S, 24)->data;
        real_T* p26 = (real_T*) ssGetRunTimeParamInfo(S, 25)->data;
        real_T* p27 = (real_T*) ssGetRunTimeParamInfo(S, 26)->data;
        real_T* p28 = (real_T*) ssGetRunTimeParamInfo(S, 27)->data;
        real_T* p29 = (real_T*) ssGetRunTimeParamInfo(S, 28)->data;
        real_T* p30 = (real_T*) ssGetRunTimeParamInfo(S, 29)->data;
        real_T* p31 = (real_T*) ssGetRunTimeParamInfo(S, 30)->data;
        int32_T* p33 = (int32_T*) ssGetRunTimeParamInfo(S, 32)->data;
        ...
        if((*p33) == 1) {
          w0=6.283185307179586*(*p20);
          pgain=2.0*(*p21)*w0*(*p22)/(*p23);
          igain=w0*w0*(*p22)/(*p23);
          wmax=(*p29)*(*p28)*0.1047197551196598;
          kpf=pgain*wmax/(*p31);
          s16PropGainShiftQ_tmp=ceil(M_LOG2E*log(fabs((double)kpf)));
          if(s16PropGainShiftQ_tmp<-15) {
            s16PropGainShiftQ_tmp=-15;
          }
          if(s16PropGainShiftQ_tmp>15) {
            s16PropGainShiftQ_tmp=15;
          }
          *p8=(int16_T)s16PropGainShiftQ_tmp;
          if((*p8)<0) {
            f16PropGainQ_tmp=kpf*32768.0*(double)(1UL << (-(*p8)));
          } else {
            f16PropGainQ_tmp=kpf*32768.0/(double)(1UL << (*p8));
          }
          if(f16PropGainQ_tmp>32767.0) {
            f16PropGainQ_tmp=32767.0;
          }
          if(f16PropGainQ_tmp<-32768.0) {
            f16PropGainQ_tmp=-32768.0;
          }
          *p6=(int16_T)f16PropGainQ_tmp;
          kif=igain*SampleTime*0.5*wmax/(*p31);
          s16IntegGainShiftQ_tmp=ceil(M_LOG2E*log(fabs((double)kif)));
          if(s16IntegGainShiftQ_tmp<-15) {
            s16IntegGainShiftQ_tmp=-15;
          }
          if(s16IntegGainShiftQ_tmp>15) {
            s16IntegGainShiftQ_tmp=15;
          }
          *p9=(int16_T)s16IntegGainShiftQ_tmp;
          if((*p9)<0) {
            f16IntegGainQ_tmp=kif*32768.0*(double)(1UL << (-(*p9)));
          } else {
            f16IntegGainQ_tmp=kif*32768.0/(double)(1UL << (*p9));
          }
          if(f16IntegGainQ_tmp>32767.0) {
            f16IntegGainQ_tmp=32767.0;
          }
          if(f16IntegGainQ_tmp<-32768.0) {
            f16IntegGainQ_tmp=-32768.0;
          }
          *p7=(int16_T)f16IntegGainQ_tmp;
          *p10=-32768;
          *p11=32767;
          fwkpf=0.9*pgain*wmax/(*p31);
          s16PropGainShiftFW_tmp=ceil(M_LOG2E*log(fabs((double)fwkpf)));
          if(s16PropGainShiftFW_tmp<-15) {
            s16PropGainShiftFW_tmp=-15;
          }
          if(s16PropGainShiftFW_tmp>15) {
            s16PropGainShiftFW_tmp=15;
          }
          *p14=(int16_T)s16PropGainShiftFW_tmp;
          if((*p14)<0) {
            f16PropGainFW_tmp=fwkpf*32768.0*(double)(1UL << (-(*p14)));
          } else {
            f16PropGainFW_tmp=fwkpf*32768.0/(double)(1UL << (*p14));
          }
          if(f16PropGainFW_tmp>32767.0) {
            f16PropGainFW_tmp=32767.0;
          }
          if(f16PropGainFW_tmp<-32768.0) {
            f16PropGainFW_tmp=-32768.0;
          }
          *p12=(int16_T)f16PropGainFW_tmp;
          *p15=(*p9);
          *p13=(*p7);
          if((*p26)<0) {
            iratio=fabs((*p26))/(*p31);
            ...
            lowlim=0.3183098861837907*acos(iratio)-0.5;
          } else {
            lowlim=0.0;
          }
          f16LowerLimitFW_tmp=lowlim*32768.0;
          if(f16LowerLimitFW_tmp>32767.0) {
            f16LowerLimitFW_tmp=32767.0;
          }
          if(f16LowerLimitFW_tmp<-32768.0) {
            f16LowerLimitFW_tmp=-32768.0;
          }
          *p16=(int16_T)f16LowerLimitFW_tmp;
          *p17=0;
          u16NSamplesW_tmp=round(M_LOG2E*log(1.0/fabs((*p24))));
          if(u16NSamplesW_tmp>15.0) {
            u16NSamplesW_tmp=15.0;
          }
          if(u16NSamplesW_tmp<0.0) {
            u16NSamplesW_tmp=0.0;
          }
          *p4=(uint16_T)u16NSamplesW_tmp;
          u16NSamplesFW_tmp=round(M_LOG2E*log(1.0/fabs((*p25))));
          if(u16NSamplesFW_tmp>15.0) {
            u16NSamplesFW_tmp=15.0;
          }
          if(u16NSamplesFW_tmp<0.0) {
            u16NSamplesFW_tmp=0.0;
          }
          *p5=(uint16_T)u16NSamplesFW_tmp;
          rampsc=(*p29)*fabs((*p27))*0.1047197551196598/wmax;
          ...
          *p19=(int32_T)f32RampDown_tmp;
        }
        AMCLIB_FWSpeedLoopInit_w_F16(__work1BUS, __work2BUS, __work3BUS, __work4BUS, __work5BUS, __work6BUS, work7, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11, *p12, *p13, *p14, *p15, *p16, *p17, *p18, *p19, *p1, *p2, *p3, *p20, *p21, *p22, *p23, *p24, *p25, *p26, *p27, *p28, *p29, *p30, *p31, *p33);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        int32_T* p2 = (int32_T*) ssGetRunTimeParamInfo(S, 1)->data;
        int32_T* p3 = (int32_T*) ssGetRunTimeParamInfo(S, 2)->data;
        int32_T* p32 = (int32_T*) ssGetRunTimeParamInfo(S, 31)->data;
