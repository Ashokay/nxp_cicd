    ...
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p24) == 1) {
          ...
          *p7=(int16_T)s16PropGainShiftQ_tmp;
          if((*p7)<0) {
            f16PropGainQ_tmp=kpf*32768.0*(double)(1UL << (-(*p7)));
          } else {
            f16PropGainQ_tmp=kpf*32768.0/(double)(1UL << (*p7));
          }
          ...
          *p8=(int16_T)s16IntegGainShiftQ_tmp;
          if((*p8)<0) {
            f16IntegGainQ_tmp=kif*32768.0*(double)(1UL << (-(*p8)));
          } else {
            f16IntegGainQ_tmp=kif*32768.0/(double)(1UL << (*p8));
          }
        ...
        AMCLIB_SpeedLoopInit_w_F16(__work1BUS, __work2BUS, __work3BUS, work4, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11, *p12, *p1, *p2, *p3, *p13, *p14, *p15, *p16, *p17, *p18, *p19, *p20, *p21, *p22, *p24);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        AMCLIB_SpeedLoop_w_F16(*u1, *u2, __work1BUS, __work2BUS, __work3BUS, work4, *u3, *u4, *u5, *u6, *u7, *u8, *u9, *u10, *u11, *u12, *u13, *u14, *u15, *u16, *u17, *u18, __y1BUS, y2, y3, y4, y5, y6, y7, y8, y9, *p1, *p2, *p3, *p23);
