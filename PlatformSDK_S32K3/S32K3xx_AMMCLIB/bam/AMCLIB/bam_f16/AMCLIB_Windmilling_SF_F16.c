...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p16) == 1) {
          adcsc=(*p14)/(*p15);
          f16ADCMaxError_tmp=adcsc*32768.0;
          if(f16ADCMaxError_tmp>32767.0) {
            f16ADCMaxError_tmp=32767.0;
          }
          if(f16ADCMaxError_tmp<-32768.0) {
            f16ADCMaxError_tmp=-32768.0;
          }
          *p2=(int16_T)f16ADCMaxError_tmp;
          ...
          if(u16NShiftPI_tmp>15) {
            u16NShiftPI_tmp=15;
          }
          *p7=(uint16_T)u16NShiftPI_tmp;
          f16CC1sc_tmp=cc1f*32768.0/(double)(1UL << (*p7));
          if(f16CC1sc_tmp>32767.0) {
            f16CC1sc_tmp=32767.0;
          }
          if(f16CC1sc_tmp<-32768.0) {
            f16CC1sc_tmp=-32768.0;
          }
          *p3=(int16_T)f16CC1sc_tmp;
          f16CC2sc_tmp=cc2f*32768.0/(double)(1UL << (*p7));
          if(f16CC2sc_tmp>32767.0) {
            f16CC2sc_tmp=32767.0;
          }
          if(f16CC2sc_tmp<-32768.0) {
            f16CC2sc_tmp=-32768.0;
          }
          *p4=(int16_T)f16CC2sc_tmp;
          *p6=-32768;
          *p5=32767;
          ...
          if(u16NShiftI_tmp>15) {
            u16NShiftI_tmp=15;
          }
          *p9=(uint16_T)u16NShiftI_tmp;
          f16C1_tmp=c1f*32768.0/(double)(1UL << (*p9));
          if(f16C1_tmp>32767.0) {
            f16C1_tmp=32767.0;
          }
          if(f16C1_tmp<-32768.0) {
            f16C1_tmp=-32768.0;
          }
          *p8=(int16_T)f16C1_tmp;
        }
        AMCLIB_WindmillingInit_w_F16(__work1BUS, *p2, *p3, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11, *p12, *p13, *p14, *p15, *p16);
