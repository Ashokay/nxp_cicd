 ...
 *    C source code generated on : 12-Sep-2023 09:21:41
 *
 */
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        double f16CC1sc_D_tmp;
        double f16CC2sc_D_tmp;
        double wmax;
        double igainsc;
        double ugainsc;
        double wigainsc;
        ...
        if((*p28) == 1) {
          ...
          *p16=(uint16_T)u16NShift_tmp;
          f16CC1sc_D_tmp=cc1f*32768.0/(double)(1UL << (*p16));
          if(f16CC1sc_D_tmp>32767.0) {
            f16CC1sc_D_tmp=32767.0;
          }
          if(f16CC1sc_D_tmp<-32768.0) {
            f16CC1sc_D_tmp=-32768.0;
          }
          *p8=(int16_T)f16CC1sc_D_tmp;
          f16CC2sc_D_tmp=cc2f*32768.0/(double)(1UL << (*p16));
          if(f16CC2sc_D_tmp>32767.0) {
            f16CC2sc_D_tmp=32767.0;
          }
          if(f16CC2sc_D_tmp<-32768.0) {
            f16CC2sc_D_tmp=-32768.0;
          }
          *p9=(int16_T)f16CC2sc_D_tmp;
          *p11=-32768;
          *p10=32767;
          *p12=(*p8);
          *p13=(*p9);
          ...
          *p7=(int16_T)s16Shift_tmp;
          f16IGain_tmp=igainsc*32768.0;
          if(f16IGain_tmp>32767.0) {
            f16IGain_tmp=32767.0;
          }
          if(f16IGain_tmp<-32768.0) {
            f16IGain_tmp=-32768.0;
          }
          *p3=(int16_T)f16IGain_tmp;
          if((*p7)<0) {
            f16UGain_tmp=ugainsc*32768.0*(double)(1UL << (-(*p7)));
          } else {
            f16UGain_tmp=ugainsc*32768.0/(double)(1UL << (*p7));
          }
          if(f16UGain_tmp>32767.0) {
            f16UGain_tmp=32767.0;
          }
          if(f16UGain_tmp<-32768.0) {
            f16UGain_tmp=-32768.0;
          }
          *p4=(int16_T)f16UGain_tmp;
          if((*p7)<0) {
            f16WIGain_tmp=wigainsc*32768.0*(double)(1UL << (-(*p7)));
          } else {
            f16WIGain_tmp=wigainsc*32768.0/(double)(1UL << (*p7));
          }
          if(f16WIGain_tmp>32767.0) {
            f16WIGain_tmp=32767.0;
          }
          if(f16WIGain_tmp<-32768.0) {
            f16WIGain_tmp=-32768.0;
          }
          *p5=(int16_T)f16WIGain_tmp;
          if((*p7)<0) {
            f16EGain_tmp=egainsc*32768.0*(double)(1UL << (-(*p7)));
          } else {
            f16EGain_tmp=egainsc*32768.0/(double)(1UL << (*p7));
          }
          if(f16EGain_tmp>32767.0) {
            f16EGain_tmp=32767.0;
          }
          if(f16EGain_tmp<-32768.0) {
            f16EGain_tmp=-32768.0;
          }
          *p6=(int16_T)f16EGain_tmp;
        }
        AMCLIB_BemfObsrvDQInit_w_F16(__work1BUS, work2, *p3, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11, *p12, *p13, *p14, *p15, *p16, *p2, *p17, *p18, *p19, *p20, *p21, *p22, *p23, *p24, *p25, *p26, *p27, *p28);
