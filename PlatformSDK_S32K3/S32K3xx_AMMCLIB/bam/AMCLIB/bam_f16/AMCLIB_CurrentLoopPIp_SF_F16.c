/**
 * AMCLIB_CurrentLoopPIp_SF_F16.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void AMCLIB_CurrentLoopPIp_w_F16(int16 u1, GFLIB_CONTROLLER_PIAW_P_T_F16 work1[1], GFLIB_CONTROLLER_PIAW_P_T_F16 work2[1], SWLIBS_2Syst_F16 u2[1], SWLIBS_2Syst_F16 u3[1], int16 u4, int16 u5, int16 u6, int16 u7, int16 u8, int16 u9, int32 u10, int16 u11, int16 u12, int16 u13, int16 u14, int16 u15, int32 u16, int16 u17, SWLIBS_2Syst_F16 y1[1], int16 y2[1], int32 y3[1], int16 y4[1], int32 y5[1], int16 y6[1], int16 work3[1], int32 p1, int32 p2)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 12-Sep-2023 09:21:14
 *
 */
...
#define S_FUNCTION_NAME  AMCLIB_CurrentLoopPIp_SF_F16
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "AMCLIB_CurrentLoopPIpInit_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "AMCLIB_CurrentLoopPIp_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_CurrentLoopPIpInit_w_F16_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_CurrentLoopPIp_w_F16_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_CurrentLoopPIp_SF_F16_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_CurrentLoopPIp_SF_F16_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __GFLIB_CONTROLLER_PIAW_P_T_F16Id);
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        double f16PropGain_D_tmp;
        double kifD;
        double s16IntegGainShift_D_tmp;
        double f16IntegGain_D_tmp;
        double kpfQ;
        double s16PropGainShift_Q_tmp;
        double f16PropGain_Q_tmp;
        double kifQ;
        double s16IntegGainShift_Q_tmp;
        double f16IntegGain_Q_tmp;
        ...
        GFLIB_CONTROLLER_PIAW_P_T_F16* __work1BUS = (GFLIB_CONTROLLER_PIAW_P_T_F16*) ssGetPWorkValue(S, 3);
        GFLIB_CONTROLLER_PIAW_P_T_F16* __work2BUS = (GFLIB_CONTROLLER_PIAW_P_T_F16*) ssGetPWorkValue(S, 4);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].f16PropGain, work1 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work1BUS[0].f16IntegGain, work1 +  __dtBusInfo[6],  __dtBusInfo[7]);
        ...
        (void) memcpy(&__work1BUS[0].f16LowerLimit, work1 +  __dtBusInfo[12],  __dtBusInfo[13]);
        (void) memcpy(&__work1BUS[0].f16UpperLimit, work1 +  __dtBusInfo[14],  __dtBusInfo[15]);
        (void) memcpy(&__work1BUS[0].f32IntegPartK_1, work1 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__work1BUS[0].f16InK_1, work1 +  __dtBusInfo[18],  __dtBusInfo[19]);
        ...
        (void) memcpy(&__work2BUS[0].f16PropGain, work2 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work2BUS[0].f16IntegGain, work2 +  __dtBusInfo[6],  __dtBusInfo[7]);
        ...
        (void) memcpy(&__work2BUS[0].f16LowerLimit, work2 +  __dtBusInfo[12],  __dtBusInfo[13]);
        (void) memcpy(&__work2BUS[0].f16UpperLimit, work2 +  __dtBusInfo[14],  __dtBusInfo[15]);
        (void) memcpy(&__work2BUS[0].f32IntegPartK_1, work2 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__work2BUS[0].f16InK_1, work2 +  __dtBusInfo[18],  __dtBusInfo[19]);
        ...
        if((*p18) == 1) {
          ...
          if(s16PropGainShift_D_tmp<-15) {
            s16PropGainShift_D_tmp=-15;
          }
          if(s16PropGainShift_D_tmp>15) {
            s16PropGainShift_D_tmp=15;
          }
          *p5=(int16_T)s16PropGainShift_D_tmp;
          if((*p5)<0) {
            f16PropGain_D_tmp=kpfD*32768.0*(double)(1UL << (-(*p5)));
          } else {
            f16PropGain_D_tmp=kpfD*32768.0/(double)(1UL << (*p5));
          }
          if(f16PropGain_D_tmp>32767.0) {
            f16PropGain_D_tmp=32767.0;
          }
          if(f16PropGain_D_tmp<-32768.0) {
            f16PropGain_D_tmp=-32768.0;
          }
          *p3=(int16_T)f16PropGain_D_tmp;
          kifD=igainD*SampleTime*0.5*(*p17)/(*p16);
          s16IntegGainShift_D_tmp=ceil(M_LOG2E*log(fabs((double)kifD)));
          if(s16IntegGainShift_D_tmp<-15) {
            s16IntegGainShift_D_tmp=-15;
          }
          if(s16IntegGainShift_D_tmp>15) {
            s16IntegGainShift_D_tmp=15;
          }
          *p6=(int16_T)s16IntegGainShift_D_tmp;
          if((*p6)<0) {
            f16IntegGain_D_tmp=kifD*32768.0*(double)(1UL << (-(*p6)));
          } else {
            f16IntegGain_D_tmp=kifD*32768.0/(double)(1UL << (*p6));
          }
          if(f16IntegGain_D_tmp>32767.0) {
            f16IntegGain_D_tmp=32767.0;
          }
          if(f16IntegGain_D_tmp<-32768.0) {
            f16IntegGain_D_tmp=-32768.0;
          }
          *p4=(int16_T)f16IntegGain_D_tmp;
          kpfQ=pgainQ*(*p17)/(*p16);
          s16PropGainShift_Q_tmp=ceil(M_LOG2E*log(fabs((double)kpfQ)));
          if(s16PropGainShift_Q_tmp<-15) {
            s16PropGainShift_Q_tmp=-15;
          }
          if(s16PropGainShift_Q_tmp>15) {
            s16PropGainShift_Q_tmp=15;
          }
          *p9=(int16_T)s16PropGainShift_Q_tmp;
          if((*p9)<0) {
            f16PropGain_Q_tmp=kpfQ*32768.0*(double)(1UL << (-(*p9)));
          } else {
            f16PropGain_Q_tmp=kpfQ*32768.0/(double)(1UL << (*p9));
          }
          if(f16PropGain_Q_tmp>32767.0) {
            f16PropGain_Q_tmp=32767.0;
          }
          if(f16PropGain_Q_tmp<-32768.0) {
            f16PropGain_Q_tmp=-32768.0;
          }
          *p7=(int16_T)f16PropGain_Q_tmp;
          kifQ=igainQ*SampleTime*0.5*(*p17)/(*p16);
          s16IntegGainShift_Q_tmp=ceil(M_LOG2E*log(fabs((double)kifQ)));
          if(s16IntegGainShift_Q_tmp<-15) {
            s16IntegGainShift_Q_tmp=-15;
          }
          if(s16IntegGainShift_Q_tmp>15) {
            s16IntegGainShift_Q_tmp=15;
          }
          *p10=(int16_T)s16IntegGainShift_Q_tmp;
          if((*p10)<0) {
            f16IntegGain_Q_tmp=kifQ*32768.0*(double)(1UL << (-(*p10)));
          } else {
            f16IntegGain_Q_tmp=kifQ*32768.0/(double)(1UL << (*p10));
          }
          if(f16IntegGain_Q_tmp>32767.0) {
            f16IntegGain_Q_tmp=32767.0;
          }
          if(f16IntegGain_Q_tmp<-32768.0) {
            f16IntegGain_Q_tmp=-32768.0;
          }
          *p8=(int16_T)f16IntegGain_Q_tmp;
        }
        AMCLIB_CurrentLoopPIpInit_w_F16(__work1BUS, __work2BUS, *p3, *p4, *p5, *p6, *p7, *p8, *p9, *p10, work3, *p2, *p11, *p12, *p13, *p14, *p15, *p16, *p17, *p18);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[4], &__work1BUS[0].f16PropGain,  __dtBusInfo[5]);
        (void) memcpy(work1 +  __dtBusInfo[6], &__work1BUS[0].f16IntegGain,  __dtBusInfo[7]);
        ...
        (void) memcpy(work1 +  __dtBusInfo[12], &__work1BUS[0].f16LowerLimit,  __dtBusInfo[13]);
        (void) memcpy(work1 +  __dtBusInfo[14], &__work1BUS[0].f16UpperLimit,  __dtBusInfo[15]);
        (void) memcpy(work1 +  __dtBusInfo[16], &__work1BUS[0].f32IntegPartK_1,  __dtBusInfo[17]);
        (void) memcpy(work1 +  __dtBusInfo[18], &__work1BUS[0].f16InK_1,  __dtBusInfo[19]);
        ...
        (void) memcpy(work2 +  __dtBusInfo[4], &__work2BUS[0].f16PropGain,  __dtBusInfo[5]);
        (void) memcpy(work2 +  __dtBusInfo[6], &__work2BUS[0].f16IntegGain,  __dtBusInfo[7]);
        ...
        (void) memcpy(work2 +  __dtBusInfo[12], &__work2BUS[0].f16LowerLimit,  __dtBusInfo[13]);
        (void) memcpy(work2 +  __dtBusInfo[14], &__work2BUS[0].f16UpperLimit,  __dtBusInfo[15]);
        (void) memcpy(work2 +  __dtBusInfo[16], &__work2BUS[0].f32IntegPartK_1,  __dtBusInfo[17]);
        (void) memcpy(work2 +  __dtBusInfo[18], &__work2BUS[0].f16InK_1,  __dtBusInfo[19]);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        AMCLIB_CurrentLoopPIp_w_F16(*u1, __work1BUS, __work2BUS, __u2BUS, __u3BUS, *u4, *u5, *u6, *u7, *u8, *u9, *u10, *u11, *u12, *u13, *u14, *u15, *u16, *u17, __y1BUS, y2, y3, y4, y5, y6, work3, *p1, *p2);
