/**
 * AMCLIB_FluxEstimAB_SF_F16.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         int16 y1 = AMCLIB_FluxEstimAB_w_F16(int16 u1, SWLIBS_2Syst_F16 u2[1], SWLIBS_2Syst_F16 u3[1], int16 u4, int16 u5, uint16 u6, int32 p1, AMCLIB_FLUXESTIMAB_T_F16 work1[1])
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 12-Sep-2023 09:22:01
 *
 */
...
#define S_FUNCTION_NAME  AMCLIB_FluxEstimAB_SF_F16
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
        ...
        ssRegisterTypeFromNamedObject(S, "AMCLIB_FLUXESTIMAB_T_F16", &dataTypeIdReg);
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "AMCLIB_FluxEstimABInit_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "AMCLIB_FluxEstimAB_w_F16", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (isSimulationTarget) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_FluxEstimABInit_w_F16_wrapper_InitializeConditions", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "AMCLIB_FluxEstimAB_w_F16_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for allocating PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_FluxEstimAB_SF_F16_wrapper_allocmem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for freeing PWork for SimulationTarget */
            ssRegMdlInfo(S, "AMCLIB_FluxEstimAB_SF_F16_wrapper_freemem", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        DTypeId __AMCLIB_FLUXESTIMAB_T_F16Id = ssGetDataTypeId(S, "AMCLIB_FLUXESTIMAB_T_F16");
        ...
        __dtSizeInfo[2] = ssGetDataTypeSize(S, __AMCLIB_FLUXESTIMAB_T_F16Id);
        ...
        /* Get information for accessing AMCLIB_FLUXESTIMAB_T_F16.f16KRs */
        __dtBusInfo[4] = ssGetBusElementOffset(S, __AMCLIB_FLUXESTIMAB_T_F16Id, 0);
        __dtBusInfo[5] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_FLUXESTIMAB_T_F16.f16KLs */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __AMCLIB_FLUXESTIMAB_T_F16Id, 1);
        __dtBusInfo[7] = __dtSizeInfo[1];

        /* Get information for accessing AMCLIB_FLUXESTIMAB_T_F16.u16NShift */
        __dtBusInfo[8] = ssGetBusElementOffset(S, __AMCLIB_FLUXESTIMAB_T_F16Id, 2);
        ...
        {
            AMCLIB_FLUXESTIMAB_T_F16* __work1BUS = (AMCLIB_FLUXESTIMAB_T_F16*)calloc(sizeof(AMCLIB_FLUXESTIMAB_T_F16), ssGetDWorkWidth(S, 0));
            if (__work1BUS==NULL) {
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        AMCLIB_FLUXESTIMAB_T_F16* __work1BUS = (AMCLIB_FLUXESTIMAB_T_F16*) ssGetPWorkValue(S, 2);

        /* Assign the Simulink structure work1 to user structure __work1BUS */
        (void) memcpy(&__work1BUS[0].f16KRs, work1 +  __dtBusInfo[4],  __dtBusInfo[5]);
        (void) memcpy(&__work1BUS[0].f16KLs, work1 +  __dtBusInfo[6],  __dtBusInfo[7]);
        ...
        if((*p11) == 1) {
          ...
          *p4=(uint16_T)u16NShift_tmp;
          f16KRs_tmp=Rssc*32768.0/(double)(1UL << (*p4));
          if(f16KRs_tmp>32767.0) {
            f16KRs_tmp=32767.0;
          }
          if(f16KRs_tmp<-32768.0) {
            f16KRs_tmp=-32768.0;
          }
          *p2=(int16_T)f16KRs_tmp;
          f16KLs_tmp=Lssc*32768.0/(double)(1UL << (*p4));
          if(f16KLs_tmp>32767.0) {
            f16KLs_tmp=32767.0;
          }
          if(f16KLs_tmp<-32768.0) {
            f16KLs_tmp=-32768.0;
          }
          *p3=(int16_T)f16KLs_tmp;
        }
        AMCLIB_FluxEstimABInit_w_F16(*p2, *p3, *p4, __work1BUS, *p5, *p6, *p7, *p8, *p9, *p10, *p11);

        /* Assign the user structure __work1BUS to the Simulink structure work1 */
        (void) memcpy(work1 +  __dtBusInfo[4], &__work1BUS[0].f16KRs,  __dtBusInfo[5]);
        (void) memcpy(work1 +  __dtBusInfo[6], &__work1BUS[0].f16KLs,  __dtBusInfo[7]);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        SWLIBS_2Syst_F16* __u2BUS = (SWLIBS_2Syst_F16*) ssGetPWorkValue(S, 0);
        SWLIBS_2Syst_F16* __u3BUS = (SWLIBS_2Syst_F16*) ssGetPWorkValue(S, 1);
        AMCLIB_FLUXESTIMAB_T_F16* __work1BUS = (AMCLIB_FLUXESTIMAB_T_F16*) ssGetPWorkValue(S, 2);
        ...
        /* Call the legacy code function */
        *y1 = AMCLIB_FluxEstimAB_w_F16(*u1, __u2BUS, __u3BUS, *u4, *u5, *u6, *p1, __work1BUS);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    /* Verify Bus/StructType 'AMCLIB_FLUXESTIMAB_T_F16', specification */
    {
        uint32_T chk[] = {2812714321, 2392339280, 1349017174, 695556430};
        int_T status;
        status = CheckDataTypeChecksum(S, "AMCLIB_FLUXESTIMAB_T_F16", &chk[0]);
        if (status==-1) {
          ssSetErrorStatus(S, "Unexpected error when checking the validity of the Simulink Bus/StructType 'AMCLIB_FLUXESTIMAB_T_F16'");
        } else if (status==0) {
          ssSetErrorStatus(S, "The Simulink Bus/StructType 'AMCLIB_FLUXESTIMAB_T_F16' definition has changed since the S-Function was generated");
        }
    }
}
