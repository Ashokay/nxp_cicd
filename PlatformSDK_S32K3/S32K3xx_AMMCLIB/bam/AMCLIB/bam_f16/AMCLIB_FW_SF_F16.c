 ...
 *    C source code generated on : 12-Sep-2023 09:22:21
 *
 */
    ...
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p21) == 1) {
          ...
          *p7=(int16_T)s16PropGainShift_tmp;
          if((*p7)<0) {
            f16PropGain_tmp=fwkpf*32768.0*(double)(1UL << (-(*p7)));
          } else {
            f16PropGain_tmp=fwkpf*32768.0/(double)(1UL << (*p7));
          }
          ...
          *p6=(int16_T)f16IntegGain_tmp;
          ...
          f16LowerLimit_tmp=lowlim*32768.0;
          ...
          *p9=(int16_T)f16LowerLimit_tmp;
          *p10=0;
          u16NSamples_tmp=round(M_LOG2E*log(1.0/fabs((*p15))));
          if(u16NSamples_tmp>15.0) {
            u16NSamples_tmp=15.0;
          }
        ...
        AMCLIB_FWInit_w_F16(__work1BUS, __work2BUS, __work3BUS, work4, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p1, *p2, *p3, *p11, *p12, *p13, *p14, *p15, *p16, *p17, *p18, *p19, *p20, *p21);
