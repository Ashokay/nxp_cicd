...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        double f16CC1sc_Q_tmp;
        double f16CC2sc_Q_tmp;
        ...
        if((*p17) == 1) {
          ...
          *p5=(uint16_T)u16NShift_D_tmp;
          ...
          if(u16NShift_Q_tmp>15) {
            u16NShift_Q_tmp=15;
          }
          *p8=(uint16_T)u16NShift_Q_tmp;
          f16CC1sc_D_tmp=cc1fd*32768.0/(double)(1UL << (*p5));
          ...
          *p3=(int16_T)f16CC1sc_D_tmp;
          f16CC2sc_D_tmp=cc2fd*32768.0/(double)(1UL << (*p5));
          ...
          *p4=(int16_T)f16CC2sc_D_tmp;
          f16CC1sc_Q_tmp=cc1fq*32768.0/(double)(1UL << (*p8));
          if(f16CC1sc_Q_tmp>32767.0) {
            f16CC1sc_Q_tmp=32767.0;
          }
          if(f16CC1sc_Q_tmp<-32768.0) {
            f16CC1sc_Q_tmp=-32768.0;
          }
          *p6=(int16_T)f16CC1sc_Q_tmp;
          f16CC2sc_Q_tmp=cc2fq*32768.0/(double)(1UL << (*p8));
          if(f16CC2sc_Q_tmp>32767.0) {
            f16CC2sc_Q_tmp=32767.0;
          }
          if(f16CC2sc_Q_tmp<-32768.0) {
            f16CC2sc_Q_tmp=-32768.0;
          }
          *p7=(int16_T)f16CC2sc_Q_tmp;
        }
        AMCLIB_CurrentLoopInit_w_F16(__work1BUS, __work2BUS, work3, *p3, *p4, *p5, *p6, *p7, *p8, *p2, *p9, *p10, *p11, *p12, *p13, *p14, *p15, *p16, *p17);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Call the legacy code function */
        AMCLIB_CurrentLoop_w_F16(*u1, __work1BUS, __work2BUS, __u2BUS, __u3BUS, work3, *u4, *u5, *u6, *u7, *u8, *u9, *u10, *u11, *u12, *u13, *u14, *u15, __y1BUS, y2, y3, y4, y5, y6, *p1, *p2);
