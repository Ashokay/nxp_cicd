 ...
 *    C source code generated on : 12-Sep-2023 09:21:19
 *
 */
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p8) == 1) {
          if((*p5) == 1) {
            cc1=(*p6);
            cc2=-(*p6)+(*p7)*SampleTime;
          } else {
            if((*p5) == 2) {
              cc1=(*p6)+(*p7)*SampleTime;
              cc2=-(*p6);
            } else {
              cc1=(*p6)+(*p7)*SampleTime*0.5;
              cc2=-(*p6)+(*p7)*SampleTime*0.5;
            }
          }
          *p3=cc1;
          *p4=cc2;
        }
        GFLIB_ControllerPIrInit_w_FLT(*p3, *p4, __work1BUS, work2, *p2, *p5, *p6, *p7, *p8);
