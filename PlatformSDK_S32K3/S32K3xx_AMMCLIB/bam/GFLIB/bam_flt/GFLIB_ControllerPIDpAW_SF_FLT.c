...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p15) == 1) {
          *p3=(*p9);
          *p4=(*p10)*SampleTime*0.5;
          exparg=-SampleTime*(*p12);
          expconst=exp(exparg);
          *p6=expconst;
          *p5=(*p11)/SampleTime*(1 - expconst);
          *p8=(*p14);
          *p7=(*p13);
        }
        GFLIB_ControllerPIDpAWInit_w_FLT(*p3, *p4, *p5, *p6, *p7, *p8, __work1BUS, work2, *p2, *p9, *p10, *p11, *p12, *p13, *p14, *p15);
