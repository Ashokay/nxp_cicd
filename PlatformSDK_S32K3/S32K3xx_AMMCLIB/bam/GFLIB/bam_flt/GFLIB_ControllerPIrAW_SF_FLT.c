 ...
 *    C source code generated on : 12-Sep-2023 09:21:30
 *
 */
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p12) == 1) {
          if((*p7) == 1) {
            cc1=(*p8);
            cc2=-(*p8)+(*p9)*SampleTime;
          } else {
            if((*p7) == 2) {
              cc1=(*p8)+(*p9)*SampleTime;
              cc2=-(*p8);
            } else {
              cc1=(*p8)+(*p9)*SampleTime*0.5;
              cc2=-(*p8)+(*p9)*SampleTime*0.5;
            }
          }
          *p5=cc1;
          *p6=cc2;
        ...
        GFLIB_ControllerPIrAWInit_w_FLT(*p3, *p4, *p5, *p6, __work1BUS, work2, *p2, *p7, *p8, *p9, *p10, *p11, *p12);
