 ...
 *    C source code generated on : 12-Sep-2023 09:21:26
 *
 */
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p15) == 1) {
          ...
          *p4=(int16_T)f16LowerLimit_tmp;
        }
        GFLIB_ControllerPIrAWInit_w_F16(*p3, *p4, *p5, *p6, *p7, __work1BUS, work2, *p2, *p8, *p9, *p10, *p11, *p12, *p13, *p14, *p15);
