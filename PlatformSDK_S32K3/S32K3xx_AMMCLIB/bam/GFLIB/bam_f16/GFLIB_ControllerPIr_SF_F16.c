 ...
 *    C source code generated on : 12-Sep-2023 09:21:15
 *
 */
    ...
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p11) == 1) {
          ...
          *p5=(uint16_T)u16NShift_tmp;
          f16CC1sc_tmp=cc1f*32768.0/(double)(1UL << (*p5));
          ...
          *p3=(int16_T)f16CC1sc_tmp;
          f16CC2sc_tmp=cc2f*32768.0/(double)(1UL << (*p5));
        ...
        GFLIB_ControllerPIrInit_w_F16(*p3, *p4, *p5, __work1BUS, work2, *p2, *p6, *p7, *p8, *p9, *p10, *p11);
