...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p15) == 1) {
          if((*p8) == 1) {
            cc1=(*p9);
            cc2=-(*p9)+(*p10)*SampleTime;
          } else {
            if((*p8) == 2) {
              cc1=(*p9)+(*p10)*SampleTime;
              cc2=-(*p9);
            } else {
              cc1=(*p9)+(*p10)*SampleTime*0.5;
              cc2=-(*p9)+(*p10)*SampleTime*0.5;
            }
          }
          cc1f=cc1*(*p13)/(*p14);
          cc2f=cc2*(*p13)/(*p14);
          ...
          *p4=(int32_T)f32LowerLimit_tmp;
        }
        GFLIB_ControllerPIrAWInit_w_F32(*p3, *p4, *p5, *p6, *p7, __work1BUS, work2, *p2, *p8, *p9, *p10, *p11, *p12, *p13, *p14, *p15);
