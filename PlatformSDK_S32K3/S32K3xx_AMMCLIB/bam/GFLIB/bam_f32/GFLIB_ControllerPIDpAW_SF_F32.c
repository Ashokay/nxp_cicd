 ...
 *    C source code generated on : 12-Sep-2023 09:21:27
 *
 */
...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    if (!ssSetNumRunTimeParams(S, 20)) return;
    ...
    ssRegDlgParamAsRunTimeParam(S, 19, 19, "p20", ssGetDataTypeId(S, "int32"));
}
#endif
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        double f32PropGain_tmp;
        double kif;
        double s16IntegGainShift_tmp;
        double f32IntegGain_tmp;
        double upperLimitf;
        double lowerLimitf;
        double f32UpperLimit_tmp;
        double f32LowerLimit_tmp;
        double exparg;
        double expconst;
        double f32FiltCoef_tmp;
        double kdf;
        double s16DerivGainShift_tmp;
        double f32DerivGain_tmp;
        ...
        int32_T* p20 = (int32_T*) ssGetRunTimeParamInfo(S, 19)->data;
        ...
        if((*p20) == 1) {
          ...
          if(s16PropGainShift_tmp<-31) {
            s16PropGainShift_tmp=-31;
          }
          if(s16PropGainShift_tmp>31) {
            s16PropGainShift_tmp=31;
          }
          *p7=(int16_T)s16PropGainShift_tmp;
          if((*p7)<0) {
            f32PropGain_tmp=kpf*2147483648.0*(double)(1UL << (-(*p7)));
          } else {
            f32PropGain_tmp=kpf*2147483648.0/(double)(1UL << (*p7));
          }
          if(f32PropGain_tmp>2147483647.0) {
            f32PropGain_tmp=2147483647.0;
          }
          if(f32PropGain_tmp<-2147483648.0) {
            f32PropGain_tmp=-2147483648.0;
          }
          *p3=(int32_T)f32PropGain_tmp;
          kif=(*p13)*SampleTime*0.5*(*p18)/(*p19);
          s16IntegGainShift_tmp=ceil(M_LOG2E*log(fabs((double)kif)));
          if(s16IntegGainShift_tmp<-31) {
            s16IntegGainShift_tmp=-31;
          }
          if(s16IntegGainShift_tmp>31) {
            s16IntegGainShift_tmp=31;
          }
          *p8=(int16_T)s16IntegGainShift_tmp;
          if((*p8)<0) {
            f32IntegGain_tmp=kif*2147483648.0*(double)(1UL << (-(*p8)));
          } else {
            f32IntegGain_tmp=kif*2147483648.0/(double)(1UL << (*p8));
          }
          if(f32IntegGain_tmp>2147483647.0) {
            f32IntegGain_tmp=2147483647.0;
          }
          if(f32IntegGain_tmp<-2147483648.0) {
            f32IntegGain_tmp=-2147483648.0;
          }
          *p4=(int32_T)f32IntegGain_tmp;
          upperLimitf=(*p17)/(*p19);
          lowerLimitf=(*p16)/(*p19);
          f32UpperLimit_tmp=upperLimitf*2147483648.0;
          if(f32UpperLimit_tmp>2147483647.0) {
            f32UpperLimit_tmp=2147483647.0;
          }
          if(f32UpperLimit_tmp<-2147483648.0) {
            f32UpperLimit_tmp=-2147483648.0;
          }
          *p11=(int32_T)f32UpperLimit_tmp;
          f32LowerLimit_tmp=lowerLimitf*2147483648.0;
          if(f32LowerLimit_tmp>2147483647.0) {
            f32LowerLimit_tmp=2147483647.0;
          }
          if(f32LowerLimit_tmp<-2147483648.0) {
            f32LowerLimit_tmp=-2147483648.0;
          }
          *p10=(int32_T)f32LowerLimit_tmp;
          exparg=-SampleTime*(*p15);
          expconst=exp(exparg);
          f32FiltCoef_tmp=expconst*2147483648.0;
          if(f32FiltCoef_tmp>2147483647.0) {
            f32FiltCoef_tmp=2147483647.0;
          }
          if(f32FiltCoef_tmp<-2147483648.0) {
            f32FiltCoef_tmp=-2147483648.0;
          }
          *p6=(int32_T)f32FiltCoef_tmp;
          kdf=(*p14)/SampleTime*(1 - expconst)*(*p18)/(*p19);
          s16DerivGainShift_tmp=ceil(M_LOG2E*log(fabs((double)kpf)));
          if(s16DerivGainShift_tmp<-31) {
            s16DerivGainShift_tmp=-31;
          }
          if(s16DerivGainShift_tmp>31) {
            s16DerivGainShift_tmp=31;
          }
          *p9=(int16_T)s16DerivGainShift_tmp;
          if((*p9)<0) {
            f32DerivGain_tmp=kpf*2147483648.0*(double)(1UL << (-(*p9)));
          } else {
            f32DerivGain_tmp=kpf*2147483648.0/(double)(1UL << (*p9));
          }
          if(f32DerivGain_tmp>2147483647.0) {
            f32DerivGain_tmp=2147483647.0;
          }
          if(f32DerivGain_tmp<-2147483648.0) {
            f32DerivGain_tmp=-2147483648.0;
          }
          *p5=(int32_T)f32DerivGain_tmp;
        }
        GFLIB_ControllerPIDpAWInit_w_F32(*p3, *p4, *p5, *p6, *p7, *p8, *p9, *p10, *p11, __work1BUS, work2, *p2, *p12, *p13, *p14, *p15, *p16, *p17, *p18, *p19, *p20);
