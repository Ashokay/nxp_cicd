...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p11) == 1) {
          if((*p6) == 1) {
            cc1=(*p7);
            cc2=-(*p7)+(*p8)*SampleTime;
          } else {
            if((*p6) == 2) {
              cc1=(*p7)+(*p8)*SampleTime;
              cc2=-(*p7);
            } else {
              cc1=(*p7)+(*p8)*SampleTime*0.5;
              cc2=-(*p7)+(*p8)*SampleTime*0.5;
            }
          }
          cc1f=cc1*(*p9)/(*p10);
          cc2f=cc2*(*p9)/(*p10);
          ...
          *p5=(uint16_T)u16NShift_tmp;
          f32CC1sc_tmp=cc1f*2147483648.0/(double)(1UL << (*p5));
          ...
          *p3=(int32_T)f32CC1sc_tmp;
          f32CC2sc_tmp=cc2f*2147483648.0/(double)(1UL << (*p5));
        ...
        GFLIB_ControllerPIrInit_w_F32(*p3, *p4, *p5, __work1BUS, work2, *p2, *p6, *p7, *p8, *p9, *p10, *p11);
