 ...
 *    C source code generated on : 12-Sep-2023 09:21:13
 *
 */
    ...
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p15) == 1) {
          ...
          *p5=(int16_T)s16PropGainShift_tmp;
          if((*p5)<0) {
            f32PropGain_tmp=kpf*2147483648.0*(double)(1UL << (-(*p5)));
          } else {
            f32PropGain_tmp=kpf*2147483648.0/(double)(1UL << (*p5));
          }
          ...
          *p3=(int32_T)f32PropGain_tmp;
          kif=(*p10)*SampleTime*0.5*(*p13)/(*p14);
          ...
          *p6=(int16_T)s16IntegGainShift_tmp;
          if((*p6)<0) {
            f32IntegGain_tmp=kif*2147483648.0*(double)(1UL << (-(*p6)));
          } else {
            f32IntegGain_tmp=kif*2147483648.0/(double)(1UL << (*p6));
          }
          ...
          *p7=(int32_T)f32LowerLimit_tmp;
        }
        GFLIB_ControllerPIpAWInit_w_F32(*p3, *p4, *p5, *p6, *p7, *p8, __work1BUS, work2, *p2, *p9, *p10, *p11, *p12, *p13, *p14, *p15);
