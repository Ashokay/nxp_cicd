 ...
 *    C source code generated on : 12-Sep-2023 09:21:16
 *
 */
...
static void mdlInitializeConditions(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        if((*p7) == 1) {
          c1f=SampleTime*0.5*(*p5)/(*p6);
          u16NShift_tmp=ceil(M_LOG2E*log(fabs((double)c1f)));
          if(u16NShift_tmp<0) {
            u16NShift_tmp=0;
          }
          if(u16NShift_tmp>31) {
          ...
          *p4=(uint16_T)u16NShift_tmp;
          f32C1_tmp=c1f*2147483648.0/(double)(1UL << (*p4));
          ...
          *p3=(int32_T)f32C1_tmp;
        }
        GFLIB_IntegratorTRInit_w_F32(*p3, *p4, __work1BUS, work2, *p2, *p5, *p6, *p7);
